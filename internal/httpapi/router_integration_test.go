...
func TestIntegrationCreateSoldat(t *testing.T) {
...
func TestIntegrationCreateSoldatValidation(t *testing.T) {
	router, _ := newIntegrationRouter(t)
...
func TestIntegrationCreateSoldatRequiresTokenWhenAuthIsEnabled(t *testing.T) {
...
func TestIntegrationFindCreatedSoldatWithETag(t *testing.T) {
	router, db := newIntegrationRouter(t)
